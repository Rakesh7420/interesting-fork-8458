...
async function citynews() {
  console.log();
  let url = `https://newsapi.org/v2/everything?q=mumbai&apiKey=d39443aca3534ef3a8ee7ad62a6a7660`;
...
async function topnews() {
  console.log();
  let url = `https://newsapi.org/v2/everything?q=top&apiKey=d39443aca3534ef3a8ee7ad62a6a7660`;
  let res = await fetch(url);
  let data = await res.json();
  console.log(data.articles);
...
async function viralnews() {
  console.log();
  let url = `https://newsapi.org/v2/everything?q=viral&apiKey=d39443aca3534ef3a8ee7ad62a6a7660`;
  let res = await fetch(url);
  let data = await res.json();
  console.log(data.articles);
